...
void playnote(int j){
	...
	__HAL_TIM_SET_AUTORELOAD(&htim1,score[j].tone);
	__HAL_TIM_SET_COMPARE(&htim1,TIM_CHANNEL_2,score[j].tone/2);
	__HAL_TIM_SET_COUNTER(&htim1,0);

	__HAL_TIM_SET_AUTORELOAD(&htim3,10*score[j].duration*TEMPO);
